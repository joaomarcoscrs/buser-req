"""
Django settings for buser-req project.
...
WSGI_APPLICATION = 'buser-req.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './buser-req.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
