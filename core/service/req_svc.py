...
def create_req(user, status, title, archived, analysis, is_trash, team, priority, category, link, description):
    Requisition.objects.create(creator=user,title=title,status=status,priority=priority,category=category,link=link,description=description,archived=archived,analysis=analysis,is_trash=is_trash,team=team)
